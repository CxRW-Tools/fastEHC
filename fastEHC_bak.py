...
aggregate_metrics = {
    ...
    'COUNT_missings': 0 # number of scans with no recorded LOC; this is currently collected but unused
    ...
    'COUNT_incremental_scan': 0, # number of incremental scans requested (includes no_scans)
    ...
    'AVG_source_pulling_time': 0, # average rouce pulling time in seconds
    ...
    'MAX_source_pulling_time': 0, # maximum rouce pulling time in seconds
    ...
    'first_scan_date': None, # the date of the first scan in the data set
    'last_scan_date': None, # the date of the last scan in the data set
    }

# Languages: Store language metrics (language_name, scan_count, scan_percentage) on a dynamic list of languages
scan_languages = {}

# Scan Origins: Store origin metrics (printable_name, scan_count, scan_percentage) on a predefined list of origins
scan_origins = {
    ...
    'MISSING ORIGIN TYPE': {'printable_name': 'MISSING ORIGIN TYPE', 'scan_count': 0, 'scan_percentage': 0}
    }

# Scan Presets: Store preset metrics (preset_name, scan_count, scan_percentage) on a dynamic list of presets
scan_presets = {}

# Scan Results: Store various results metrics for every scan (total_results, high_results, medium_results, low_results, info_results)
# Note this is not for storing actual scan results
scan_results = {}

# Scan Times: Store various times for every scan (source_pulling_time, queue_time, engine_scan_time, total_scan_time)
scan_times = {}
